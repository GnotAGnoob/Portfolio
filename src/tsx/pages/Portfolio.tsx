...
export const Portfolio: FunctionComponent = () => {
	...
	return (
		<>
			...
			<div className="grid grid-cols-[repeat(auto-fit,minmax(33ch,1fr))] md:grid-cols-[repeat(auto-fit,minmax(40ch,1fr))] lg:grid-cols-[repeat(auto-fit,minmax(42ch,1fr))] place-content-center gap-20 mt-12 md:mt-20 sm:px-5">
